  ...
  return (
    <div className="navbar bg-slate-100 dark:bg-cyan-900 p-4">
      ...
      <div className="lg:flex-1 navbar-center">
        <img src={logo} alt="logo" className="w-10 h-10 me-2 rounded-lg"></img>
      ...
      <div className="navbar-end flex flex-auto lg:hidden p-2">
        <div>
          <button
            className="btn text-black rounded-full mx-2 text-lg border-2 bg-yellow-200 hover:bg-yellow-300 hover:border-yellow-400 border-yellow-400 shadow-md dark:text-white hover:dark:bg-gray-800 dark:bg-black dark:border-gray-700"
            type="button"
            onClick={() => {
              dispatch(changeTheme());
            }}
